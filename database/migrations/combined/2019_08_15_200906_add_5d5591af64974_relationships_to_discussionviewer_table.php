...
class Add5d5591af64974RelationshipsToDiscussionViewerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('discussion_viewers', function(Blueprint $table) {
            if(Schema::hasColumn('discussion_viewers', 'discussion_id')) {
                $table->dropForeign('332963_5d4e05f56b819');
                $table->dropIndex('332963_5d4e05f56b819');
