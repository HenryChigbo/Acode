...
class Add5d5591aedfbd7RelationshipsToDiscussionCommentTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('discussion_comments', function(Blueprint $table) {
            if(Schema::hasColumn('discussion_comments', 'discussion_id')) {
                $table->dropForeign('332962_5d4e055b01468');
                $table->dropIndex('332962_5d4e055b01468');
                $table->dropColumn('discussion_id');
            }
            if(Schema::hasColumn('discussion_comments', 'user_id')) {
                $table->dropForeign('332962_5d4e055b26ae2');
                $table->dropIndex('332962_5d4e055b26ae2');
