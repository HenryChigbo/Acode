...
class Add5d5591ac0b94fRelationshipsToUserLessonTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('user_lessons', function(Blueprint $table) {
            if(Schema::hasColumn('user_lessons', 'users_id')) {
                $table->dropForeign('332925_5d4db5b01522c');
                $table->dropIndex('332925_5d4db5b01522c');
                $table->dropColumn('users_id');
            }
            if(Schema::hasColumn('user_lessons', 'lesson_id')) {
                $table->dropForeign('332925_5d4db5b040b7b');
                $table->dropIndex('332925_5d4db5b040b7b');
