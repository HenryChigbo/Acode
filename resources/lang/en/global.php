...
return [
	...
		'daily-challenge-flag' => [		'title' => 'Daily challenge flag',		'fields' => [			'counter' => 'Counter',			'daily-challenge' => 'Daily challenge id',		],	],
		'daily-challenge-comment' => [		'title' => 'Daily challenge comment',		'fields' => [			'comment' => 'Comment',			'daily-challenge' => 'Daily challenge id',			'user' => 'User id',		],	],
		'daily-challenge-comment-flag' => [		'title' => 'Daily challenge comment flag',		'fields' => [			'counter' => 'Counter',			'user' => 'User id',			'daily-challenge-comment' => 'Daily challenge comment',		],	],
		'discussion' => [		'title' => 'Discussion',		'fields' => [			'question' => 'Question',			'tags' => 'Tags',			'description' => 'Description',			'post' => 'Post',			'user' => 'User id',		],	],
		'discussion-flag' => [		'title' => 'Discussion flag',		'fields' => [			'discussion' => 'Discussion id',			'user' => 'User id',			'counter' => 'Counter',		],	],
		'discussion-comment' => [		'title' => 'Discussion comment',		'fields' => [			'comment' => 'Comment',			'discussion' => 'Discussion id',			'user' => 'User id',		],	],
		'discussion-viewer' => [		'title' => 'Discussion viewer',		'fields' => [			'discussion' => 'Discussion id',			'counter' => 'Counter',		],	],
		'courses' => [		'title' => 'Courses',		'fields' => [			'name' => 'Name',			'image' => 'Image',			'key' => 'Key',		],	],
		'banners' => [		'title' => 'Banners',		'fields' => [			'photo-one' => 'Photo one',			'photo-two' => 'Photo two',			'photo-three' => 'Photo three',			'photo-four' => 'Photo four',			'photo-five' => 'Photo five',		],	],
	...
	'global_title' => 'Complete Code Admin',
];